...
if trade_type == 'stock' and (today.strftime('%a') == 'Sat' or today.strftime('%a') == 'Sun'):
    ...
    image1 = Image.open('BTC-USD.jpg')
    image2 = Image.open('ETH-USD.jpg')
    image3 = Image.open('BNB-USD.jpg')
    image4 = Image.open('DOGE-USD.jpg')
    ...
    merged_image.save('crypto1.jpg')



######################################
######################################
##### crypto (Export to Twitter)
######################################
######################################
...
if df['date'][len(df)-1] == today:
    ...
    # api.update_status_with_media(status=update, filename='crypto1.jpg')
