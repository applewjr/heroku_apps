...
gmail_subject = 'stock_bot_stock3.py'
gmail_list = []
...
if trade_type == 'stock' and (today.strftime('%a') == 'Sat' or today.strftime('%a') == 'Sun'):
    ...
    image1 = Image.open('ORCL.jpg')
    image2 = Image.open('SBUX.jpg')
    image3 = Image.open('TSLA.jpg')
    image4 = Image.open('TSM.jpg')
    ...
    merged_image.save('stock3.jpg')



######################################
######################################
##### stock3 (Export to Twitter)
######################################
######################################
...
if df['date'][len(df)-1] == today:
    ...
    # api.update_status_with_media(status=update, filename='stock3.jpg')
