...
# # stock choices
# trade_type = 'stock'
# stock_list = ['AAPL', 'AMD', 'AMZN', 'CRM', 'GOOG', 'INTC', 'MSFT', 'NVDA', 'ORCL', 'SBUX', 'TSLA', 'TSM'] # core list
...
# trade_type = 'crypto'
# stock_list = ['BTC-USD']
# contrib_amt = contrib_amt = [dict_policy['amt'][amt] for amt in stock_list]
# stock_list1 = ['BTC-USD']
# total_weeks = 104
# multiplier = 3
# segment_name = 'crypto graph'
...
######################################
######################################
##### stocks part 2 (Export to Twitter, txt)
######################################
######################################
...
if df['date'][len(df)-1] == today:
    ...
    api.update_status(status = update, media_ids = [GOOG.media_id, INTC.media_id, MSFT.media_id, NVDA.media_id])
...
if df['date'][len(df)-1] == today:
    ...
    api.update_status(status = update, media_ids = [ORCL.media_id, SBUX.media_id, TSLA.media_id, TSM.media_id])
