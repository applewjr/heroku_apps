...
# total_weeks = 104
# multiplier = 5
# segment_name = 'stock 1-3'
# output_1_jpg = 'stock1.jpg'
...
if trade_type == 'stock' and (today.strftime('%a') == 'Sat' or today.strftime('%a') == 'Sun'):
    ...
    images = []
    for input_image in input_4_jpg:
    ...
    # Resize the remaining images to match the dimensions of the first image
    ...
    merged_image.save(output_1_jpg)
...
if df['date'][len(df)-1] == today:
    ...
    api.update_status_with_media(status=update, filename=output_1_jpg)
